...
import { Users, Target, Award, Globe, ArrowRight, CheckCircle, Heart, Star } from 'lucide-react';
  ...
  const values = [
    {
      ...
      description: "Every decision we make puts student success and satisfaction at the center."
    },
    {
      icon: <Star className="h-12 w-12 text-orange-500" />,
      title: "Excellence",
      description: "We maintain the highest standards in everything we do, from counseling to support."
    },
    {
    ...
    },
    {
      ...
      title: "Global Vision",
      description: "We help students become global citizens prepared for international success."
    }
  ];
  ...
  const team = [
    {
      ...
      description: "Former university administrator with extensive experience in global education partnerships."
    },
    {
      ...
      description: "Certified education counselor who has guided over 2000+ students to their dream universities."
    },
    {
      name: "Mr. Amit Patel",
      ...
      description: "Former visa officer with deep understanding of international visa regulations and processes."
    },
    {
      ...
      description: "Maintains relationships with 500+ universities across 15+ countries worldwide."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl lg:text-2xl text-blue-100 mb-8 leading-relaxed">
                Empowering students to achieve their international education dreams through expert guidance and unwavering support since 2010.
              </p>
              <Link
                to="/contact"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-blue-50 p-8 rounded-xl">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                To democratize global education by providing expert guidance, comprehensive support, and personalized services that make studying abroad accessible, affordable, and successful for every student who dreams of international education.
              </p>
            </div>
            <div className="bg-orange-50 p-8 rounded-xl">
              <Globe className="h-12 w-12 text-orange-700 mb-6" />
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Vision</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                To be the world's most trusted overseas education consultancy, recognized for transforming lives through international education and creating a global community of successful, culturally aware professionals.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl lg:text-5xl font-bold text-orange-400 mb-2">{achievement.number}</div>
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="p-6 flex-1">
                    ...
                    <p className="text-blue-600 text-sm mb-3">{member.experience} Experience</p>
                    <p className="text-gray-700 text-sm mb-3">{member.specialization}</p>
      ...
      <section className="py-16 bg-orange-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8">
            Join thousands of successful students who trusted our expert team with their study abroad journey.
          </p>
          <Link
            to="/contact"
