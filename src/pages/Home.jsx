...
import { ArrowRight, Users, Award, Globe, BookOpen, CheckCircle, Star } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                Start Your Study Abroad Journey with <span className="text-orange-400">Visa Dunia Overseas</span>
              </h1>
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Transform your future with world-class education. We provide expert guidance, visa assistance, and complete support for your international education dreams.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                country: 'USA',
                image: 'https://images.pexels.com/photos/2041396/pexels-photo-2041396.jpeg?auto=compress&cs=tinysrgb&w=400',
                universities: '4,000+',
                description: 'World\'s largest higher education system'
              },
              {
                country: 'UK',
                image: 'https://images.pexels.com/photos/726484/pexels-photo-726484.jpeg?auto=compress&cs=tinysrgb&w=400',
                universities: '150+',
                description: 'Home to world\'s oldest universities'
              },
              {
                country: 'Canada',
                image: 'https://images.pexels.com/photos/1574937/pexels-photo-1574937.jpeg?auto=compress&cs=tinysrgb&w=400',
                universities: '100+',
                description: 'Affordable quality education & immigration'
              }
            ].map((dest, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <img src={dest.image} alt={dest.country} className="w-full h-48 object-cover" />
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-2">{dest.country}</h3>
                  <p className="text-orange-500 font-semibold mb-2">{dest.universities} Universities</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Free Consultation", description: "Discuss your goals and preferences" },
              { step: "02", title: "University Selection", description: "Find the perfect match for your profile" },
              { step: "03", title: "Application & Visa", description: "Complete application and visa processing" },
              { step: "04", title: "Pre-Departure", description: "Prepare for your journey abroad" }
            ].map((process, index) => (
              ...
              <div key={index} className="bg-white rounded-lg p-6 shadow-lg">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Studying in {testimonial.country}</p>
                  </div>
                </div>
