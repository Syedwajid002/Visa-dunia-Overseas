...
const Gallery = () => {
  const successStories = [
    {
      ...
      testimonial: "Visa Dunia made my dream of studying in Canada a reality. Their guidance through the application and visa process was exceptional. Now I'm pursuing my Master's at one of the top universities in the world!",
    ...
    },
    {
      ...
      testimonial: "The team at Visa Dunia provided incredible support throughout my MBA application process. Their essay writing guidance and interview preparation were game-changers. Stanford here I come!",
    ...
    },
    {
      ...
      testimonial: "Professional, reliable, and supportive - that's Visa Dunia in three words. They helped me navigate the complex Australian visa process and secured my place at Melbourne University.",
    ...
    },
    {
      ...
      testimonial: "Oxford was always a dream, and Visa Dunia made it possible. Their expertise in UK applications and scholarship guidance was invaluable. Forever grateful!",
    ...
    },
    {
      ...
      testimonial: "Studying in Germany was affordable and high-quality thanks to Visa Dunia's guidance. They helped me understand the German education system and secure admission without any hassle.",
    ...
    },
    {
      ...
      testimonial: "The personalized attention and detailed guidance I received from Visa Dunia was outstanding. They made the entire process smooth and stress-free.",
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      image: "https://images.pexels.com/photos/534229/pexels-photo-534229.jpeg?auto=compress&cs=tinysrgb&w=400",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-purple-100 max-w-3xl mx-auto">
              Celebrating the achievements of our students who are now thriving in universities around the world.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="p-8">
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-orange-500 font-semibold">{story.program}</p>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg mb-4">
                    <div className="text-green-800 font-semibold text-sm">Achievement:</div>
      ...
      <section className="py-16 bg-orange-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8">
            Join thousands of successful students and start your study abroad journey with expert guidance.
          </p>
          <Link
            to="/contact"
