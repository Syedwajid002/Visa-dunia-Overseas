          ...
          <div className="space-y-16">
            {services.map((service, index) => (
              <div
                ...
                } gap-12 items-center bg-white rounded-xl p-8 shadow-lg`}
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-[#035079]/30"></div>
            <div className="space-y-12">
              {[
                ...
                <div key={index} className="relative flex items-center">
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#035079] rounded-full"></div>
                  <div
                    className={`w-1/2 ${
                      index % 2 === 0 ? "pr-12 text-right" : "pl-12 ml-auto"
                    }`}
                  >
                    <div className="bg-blue-50 p-6 rounded-lg shadow-lg border border-[#035079]/20">
                      <div className="text-[#035079] font-semibold mb-2">
                        {step.time}
                      </div>
