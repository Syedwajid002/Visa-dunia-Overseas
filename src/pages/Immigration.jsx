...
import { MapPin, Clock, Award, Users, ArrowRight, CheckCircle, FileText, TrendingUp } from 'lucide-react';
...
const Immigration = () => {
      ...
      programs: [
        {
          ...
          requirements: ['Bachelor\'s degree', 'IELTS 6.0+', 'Work experience', 'Age under 47'],
        ...
        },
        {
          ...
          requirements: ['Job offer from province', 'Relevant education', 'Work experience', 'Language proficiency'],
        ...
        },
        {
          ...
          requirements: ['Canadian education', 'Work permit', 'Canadian experience', 'Language test'],
      ...
      programs: [
        {
          ...
          requirements: ['Skilled occupation', 'Age under 45', 'English proficiency', '65+ points'],
        ...
        },
        {
          ...
          requirements: ['State nomination', 'Skilled occupation', 'Work experience', 'English test'],
        ...
        },
        {
          ...
          requirements: ['Australian qualification', 'Age under 50', 'Health insurance', 'English proficiency'],
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-green-700 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-green-100 max-w-3xl mx-auto mb-8">
              Turn your international education into permanent residency with our expert immigration guidance and support.
            </p>
            <Link
              to="/contact"
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-3">
                  ...
                  <div className="lg:col-span-2 p-8">
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Immigration Programs</h3>
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-gray-700">{program.processing}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Eligibility Assessment", description: "Comprehensive evaluation of your profile and immigration options" },
              { step: "02", title: "Documentation", description: "Preparation and verification of all required documents" },
              { step: "03", title: "Application & Follow-up", description: "Application submission and status tracking until approval" }
            ].map((step, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Get a free assessment of your immigration eligibility and explore your options with our expert counselors.
          </p>
          <Link
            to="/contact"
            className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors inline-flex items-center"
